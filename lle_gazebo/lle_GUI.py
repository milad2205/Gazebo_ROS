...
def launch():
	...
	launch = roslaunch.parent.ROSLaunchParent(uuid, ["/home/milad/catkin_ws/src/lle_gazebo/launch/lle_gazebo.launch"])
	launch.start()
	
def walk_run():
	roswalk = os.popen('/home/milad/catkin_ws/src/lle_gazebo/src/walker.py')
	#os.system('/home/milad/catkin_ws/src/lle_gazebo/src/walker.py')
